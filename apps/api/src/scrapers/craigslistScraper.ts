...
export async function scrapeCraigslist(vehicle: NormalizedVehicle): Promise<ScrapedComparable[]> {
...
export function parseCraigslistHtml(html: string, vehicle: NormalizedVehicle): ScrapedComparable[] {
  const results: ScrapedComparable[] = [];
...
function buildCraigslistUrl(vehicle: NormalizedVehicle) {
